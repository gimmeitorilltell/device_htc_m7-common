...
#define PATCH_R "/vendor/etc/tfa/tfa9887.patch"
#define PATCH_L "/vendor/etc/tfa/tfa9887_l.patch"
#define SPKR_R "/vendor/etc/tfa/deftcoefA.speaker"
#define SPKR_L "/vendor/etc/tfa/deftcoefA_l.speaker"

#define CONFIG_PLAYBACK_R "/vendor/etc/tfa/playback.config"
#define CONFIG_PLAYBACK_L "/vendor/etc/tfa/playback_l.config"
#define CONFIG_RING_R "/vendor/etc/tfa/ring.config"
#define CONFIG_RING_L "/vendor/etc/tfa/ring_l.config"
#define CONFIG_VOICE_R "/vendor/etc/tfa/voice.config"
#define CONFIG_VOICE_L "/vendor/etc/tfa/voice_l.config"
#define CONFIG_VOIP_R "/vendor/etc/tfa/voip.config"
#define CONFIG_VOIP_L "/vendor/etc/tfa/voip_l.config"

#define PRESET_PLAYBACK_R "/vendor/etc/tfa/playback.preset"
#define PRESET_PLAYBACK_L "/vendor/etc/tfa/playback_l.preset"
#define PRESET_RING_R "/vendor/etc/tfa/ring.preset"
#define PRESET_RING_L "/vendor/etc/tfa/ring_l.preset"
...
#define EQ_RING_R "/vendor/etc/tfa/ring.eq"
#define EQ_RING_L "/vendor/etc/tfa/ring_l.eq"
